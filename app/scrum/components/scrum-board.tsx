                                                                ...
                                                                <div className="flex items-center justify-between">
                                                                    <div className="flex space-x-2">
                                                                        <button
                                                                            ...
                                                                            className="inline-flex items-center px-2 py-1 border border-gray-300 rounded-md text-xs font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-indigo-500"
                                                                        >
                                                                            <svg
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        className={`inline-flex items-center px-3 py-1 border border-transparent rounded-md shadow-sm text-xs font-medium text-white ${!commentText.trim() && attachments.length === 0
                                                                            ...
                                                                            : "bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-1 focus:ring-indigo-500"
                                                                            }`}
                                                                    >
                                                                        Comentar
                                                                    </button>
                                                ...
                                                <div className="mt-3">
                                                    ...
                                                    <div className="mt-1">
                                                        ...
                                                        <div className="flex justify-between mt-1">
                                                            ...
                                                            <span className="text-xs text-gray-500">
                                                                {selectedTask.status === "done" ? "Completado" : "En progreso"}
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
