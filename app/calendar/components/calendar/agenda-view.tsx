...
export default function AgendaView({ currentDate, events }: AgendaViewProps) {
  ...
  return (
    <div className="bg-background dark:bg-gray-800 overflow-auto max-h-[600px]">
      {days.map((day, dayIdx) => {
        ...
        return (
          <div key={dayIdx} className="border-b border-gray-200 dark:border-gray-700 last:border-0">
            <div className="sticky top-0 bg-muted dark:bg-gray-900 px-6 py-3 font-medium text-gray-900 dark:text-gray-100 shadow-sm z-10">
            ...
            <div className="divide-y divide-gray-100 dark:divide-gray-800">
              {dayEvents.map((event, eventIdx) => (
                <div
                  key={eventIdx}
                  className="p-4 hover:bg-muted/50 dark:hover:bg-gray-900/50 transition-colors flex cursor-pointer"
                >
